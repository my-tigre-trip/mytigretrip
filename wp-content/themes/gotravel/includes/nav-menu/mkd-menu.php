...
add_filter('wp_setup_nav_menu_item', 'gotravel_mikado_add_custom_nav_fields');

// save menu custom fields
add_action('wp_update_nav_menu_item', 'gotravel_mikado_update_custom_nav_fields', 10, 3);

// edit menu walker
add_filter('wp_edit_nav_menu_walker', 'gotravel_mikado_edit_walker', 10, 2);

function gotravel_mikado_add_custom_nav_fields($menu_item) {
 ...
 * @return      void
 */
function gotravel_mikado_update_custom_nav_fields($menu_id, $menu_item_db_id, $args) {
	$check = array(
		'anchor',
		'nolink',
		'hide',
 ...
 * @return      void
 */
function gotravel_mikado_edit_walker($walker, $menu_id) {

	return 'GoTravelMikado_Walker_Nav_Menu_Edit_Custom';
}
