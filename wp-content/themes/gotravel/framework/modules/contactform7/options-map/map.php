...
if(!function_exists('gotravel_mikado_contact_form_7_options_map')) {

    function gotravel_mikado_contact_form_7_options_map() {

        gotravel_mikado_add_admin_page(array(
            'slug'  => '_contact_form7_page',
            'title' => esc_html__('Contact Form 7', 'gotravel'),
            'icon'  => 'fa fa-envelope-o'
        ));

        $panel_contact_form_style_1 = gotravel_mikado_add_admin_panel(array(
            'page'  => '_contact_form7_page',
            'name'  => 'panel_contact_form_style_1',
            'title' => esc_html__('Custom Style 1', 'gotravel')
        ));

        //Text Typography

        $typography_text_group = gotravel_mikado_add_admin_group(array(
            'name'        => 'typography_text_group',
            'title'       => esc_html__('Form Text Typography', 'gotravel'),
            'description' => esc_html__('Setup typography for form elements text', 'gotravel'),
            'parent'      => $panel_contact_form_style_1
        ));

        $typography_text_row1 = gotravel_mikado_add_admin_row(array(
        ...
        gotravel_mikado_add_admin_field(array(
            ...
            'default_value' => '',
            'label'         => esc_html__('Focus Text Color', 'gotravel'),
        ));
        ...
        $typography_text_row2 = gotravel_mikado_add_admin_row(array(
        ...
        $typography_text_row3 = gotravel_mikado_add_admin_row(array(
        ...
        $typography_label_group = gotravel_mikado_add_admin_group(array(
            'name'        => 'typography_label_group',
            'title'       => esc_html__('Form Label Typography', 'gotravel'),
            'description' => esc_html__('Setup typography for form elements label', 'gotravel'),
            'parent'      => $panel_contact_form_style_1
        ));

        $typography_label_row1 = gotravel_mikado_add_admin_row(array(
        ...
        $typography_label_row2 = gotravel_mikado_add_admin_row(array(
        ...
        $background_border_group = gotravel_mikado_add_admin_group(array(
            'name'        => 'background_border_group',
            'title'       => esc_html__('Form Elements Background and Border', 'gotravel'),
            'description' => esc_html__('Setup form elements background and border style', 'gotravel'),
            'parent'      => $panel_contact_form_style_1
        ));

        $background_border_row1 = gotravel_mikado_add_admin_row(array(
        ...
        gotravel_mikado_add_admin_field(array(
            ...
            'default_value' => '',
            'label'         => esc_html__('Focus Background Color', 'gotravel')
        ));
        ...
        gotravel_mikado_add_admin_field(array(
            ...
            'default_value' => '',
            'label'         => esc_html__('Focus Background Transparency', 'gotravel')
        ));

        $background_border_row2 = gotravel_mikado_add_admin_row(array(
        ...
        gotravel_mikado_add_admin_field(array(
            ...
            'default_value' => '',
            'label'         => esc_html__('Border Transparency', 'gotravel'),
        ));
        ...
        gotravel_mikado_add_admin_field(array(
            ...
            'default_value' => '',
            'label'         => esc_html__('Focus Border Color', 'gotravel')
        ));
        ...
        gotravel_mikado_add_admin_field(array(
            ...
            'default_value' => '',
            'label'         => esc_html__('Focus Border Transparency', 'gotravel')
        ));

        $background_border_row3 = gotravel_mikado_add_admin_row(array(
        ...
        gotravel_mikado_add_admin_field(array(
            ...
            'default_value' => '',
            'label'         => esc_html__('Border Width', 'gotravel'),
            'args'          => array(
                'suffix' => 'px'
            )
        ));
        ...
        gotravel_mikado_add_admin_field(array(
            ...
            'default_value' => '',
            'label'         => esc_html__('Border Radius', 'gotravel'),
            'args'          => array(
                'suffix' => 'px'
            )
        ));
        ...
        $padding_group = gotravel_mikado_add_admin_group(array(
            'name'        => 'padding_group',
            'title'       => esc_html__('Elements Padding', 'gotravel'),
            'description' => esc_html__('Setup form elements padding', 'gotravel'),
            'parent'      => $panel_contact_form_style_1
        ));

        $padding_row = gotravel_mikado_add_admin_row(array(
            'name'   => 'padding_row',
        ...
        gotravel_mikado_add_admin_field(array(
            ...
            'default_value' => '',
            'label'         => esc_html__('Padding Top', 'gotravel'),
            'args'          => array(
                'suffix' => 'px'
            )
        ));
        ...
        gotravel_mikado_add_admin_field(array(
            ...
            'default_value' => '',
            'label'         => esc_html__('Padding Bottom', 'gotravel'),
            'args'          => array(
                'suffix' => 'px'
            )
        ));
        ...
        $margin_group = gotravel_mikado_add_admin_group(array(
            'name'        => 'margin_group',
            'title'       => esc_html__('Elements Margin', 'gotravel'),
            'description' => esc_html__('Setup form elements margin', 'gotravel'),
            'parent'      => $panel_contact_form_style_1
        ));

        $margin_row = gotravel_mikado_add_admin_row(array(
            'name'   => 'margin_row',
            'parent' => $margin_group
        ));
        ...
        gotravel_mikado_add_admin_field(array(
            ...
            'default_value' => '',
            'label'         => esc_html__('Textarea Height', 'gotravel'),
            'description'   => esc_html__('Enter height for textarea form element', 'gotravel'),
            'args'          => array(
                'col_width' => '3',
                'suffix'    => 'px'
            )
        ...
        $button_typography_group = gotravel_mikado_add_admin_group(array(
            'name'        => 'button_typography_group',
            'title'       => esc_html__('Button Typography', 'gotravel'),
            'description' => esc_html__('Setup button text typography', 'gotravel'),
            'parent'      => $panel_contact_form_style_1
        ));

        $button_typography_row1 = gotravel_mikado_add_admin_row(array(
        ...
        $button_typography_row2 = gotravel_mikado_add_admin_row(array(
        ...
        $button_background_border_group = gotravel_mikado_add_admin_group(array(
            'name'        => 'button_background_border_group',
            'title'       => esc_html__('Button Background and Border', 'gotravel'),
            'description' => esc_html__('Setup button background and border style', 'gotravel'),
            'parent'      => $panel_contact_form_style_1
        ));

        $button_background_border_row1 = gotravel_mikado_add_admin_row(array(
        ...
        gotravel_mikado_add_admin_field(array(
            ...
            'default_value' => '',
            'label'         => esc_html__('Background Hover Transparency', 'gotravel')
        ));

        $button_background_border_row2 = gotravel_mikado_add_admin_row(array(
        ...
        gotravel_mikado_add_admin_field(array(
            ...
            'default_value' => '',
            'label'         => esc_html__('Border Hover Color', 'gotravel')
        ));
        ...
        gotravel_mikado_add_admin_field(array(
            ...
            'default_value' => '',
            'label'         => esc_html__('Border Hover Transparency', 'gotravel')
        ));

        $button_background_border_row3 = gotravel_mikado_add_admin_row(array(
        ...
        gotravel_mikado_add_admin_field(array(
            ...
            'default_value' => '',
            'label'         => esc_html__('Button Height', 'gotravel'),
            'description'   => esc_html__('Insert form button height', 'gotravel'),
            'args'          => array(
                'col_width' => '3',
                'suffix'    => 'px'
            )
        ...
        gotravel_mikado_add_admin_field(array(
            ...
            'default_value' => '',
            'label'         => esc_html__('Button Left/Right Padding', 'gotravel'),
            'description'   => esc_html__('Enter value for button left and right padding', 'gotravel'),
            'args'          => array(
                'col_width' => '3',
                'suffix'    => 'px'
            )
        ...
        gotravel_mikado_add_admin_field(array(
            ...
            'default_value' => 'no',
            'label'         => esc_html__('Show Full Width Button', 'gotravel'),
            'description'   => esc_html__('Set this option to "Yes" if you would like the Content Form button to be full width', 'gotravel'),
        ));

        $panel_contact_form_style_2 = gotravel_mikado_add_admin_panel(array(
            'page'  => '_contact_form7_page',
            'name'  => 'panel_contact_form_style_2',
            'title' => esc_html__('Custom Style 2', 'gotravel')
        ));
        ...
        $panel_contact_form_style_3 = gotravel_mikado_add_admin_panel(array(
            'page'  => '_contact_form7_page',
            'name'  => 'panel_contact_form_style_3',
            'title' => esc_html__('Custom Style 3', 'gotravel')
        ));
        ...
        $panel_contact_form_style_4 = gotravel_mikado_add_admin_panel(array(
            'page'  => '_contact_form7_page',
            'name'  => 'panel_contact_form_style_4',
            'title' => esc_html__('Custom Style 4', 'gotravel')
        ));
        ...
        gotravel_mikado_add_admin_field(array(
            'parent'        => $panel_contact_form_style_4,
            'type'          => 'yesno',
            'name'          => 'cf7_style_4_button_full_width',
            'default_value' => 'no',
            'label'         => esc_html__('Show Full Width Button', 'gotravel'),
            'description'   => esc_html__('Set this option to "Yes" if you would like the Content Form button to be full width', 'gotravel'),
        ));
    ...
    add_action('gotravel_mikado_options_map', 'gotravel_mikado_contact_form_7_options_map', 19);
