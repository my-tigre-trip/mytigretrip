<?php if(gotravel_mikado_options()->getOptionValue('blog_single_navigation') == 'yes') { ?>
    <?php $navigation_blog_through_category = gotravel_mikado_options()->getOptionValue('blog_navigation_through_same_category') ?>
                    ...
                    <?php if($prev_post_has_image) : ?>
                        <div class="mkdf-single-nav-image-holder">
                            <a href="<?php echo esc_url($prev_post['link']); ?>">
                                <?php echo gotravel_mikado_kses_img($prev_post['image']); ?>
                                <div class="mkdf-single-image-overlay">
                                    <?php echo gotravel_mikado_icon_collections()->renderIcon('arrow_carrot-left', 'font_elegant') ?>
                                </div>
                            </a>
            ...
            <?php if($has_next_post) : ?>
                <div class="mkdf-blog-single-next clearfix <?php if($next_post_has_image) {
                    ...
                    <?php if($next_post_has_image) : ?>
                        <div class="mkdf-single-nav-image-holder">
                            <a href="<?php echo esc_url($next_post['link']); ?>">
                                <?php echo gotravel_mikado_kses_img($next_post['image']); ?>
                                <div class="mkdf-single-image-overlay">
                                    <?php echo gotravel_mikado_icon_collections()->renderIcon('arrow_carrot-right', 'font_elegant') ?>
                                </div>
                            </a>
                        </div>
                    <?php endif; ?>
