<?php gotravel_mikado_get_module_template_part('templates/lists/parts/filter', 'blog'); ?>
	<div class="mkdf-blog-holder mkdf-blog-type-masonry mkdf-masonry-full-width mkdf-masonry-pagination-<?php echo gotravel_mikado_options()->getOptionValue('masonry_pagination'); ?>">
...
if(gotravel_mikado_options()->getOptionValue('pagination') == 'yes') {
	...
	$pagination_type = gotravel_mikado_options()->getOptionValue('masonry_pagination');
