<div class="mkdf-blog-holder mkdf-blog-type-split-column <?php echo esc_attr($blog_classes) ?>" data-blog-type="<?php echo esc_attr($blog_type) ?>" <?php echo esc_attr(gotravel_mikado_set_blog_holder_data_params()); ?> >
	<?php
