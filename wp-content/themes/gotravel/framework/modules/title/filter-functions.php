...
if(!function_exists('gotravel_mikado_title_classes')) {
	/**
	 ...
	 */
	function gotravel_mikado_title_classes($classes = array()) {
		$classes = array();
		$classes = apply_filters('gotravel_mikado_title_classes', $classes);
...
if(!function_exists('gotravel_mikado_title_background_image_classes')) {
	/**
	 * @param $classes
	 *
	 * @return array
	 */
	function gotravel_mikado_title_background_image_classes($classes) {
		//init variables
		...
		if(($meta_temp = get_post_meta($id, "mkdf_title_area_background_image_meta", true)) != "") {
			...
			$title_img = gotravel_mikado_options()->getOptionValue('title_area_background_image');
		}
		...
		if(($meta_temp = get_post_meta($id, "mkdf_title_area_background_image_parallax_meta", true)) != "") {
			...
			$is_image_parallax = gotravel_mikado_options()->getOptionValue('title_area_background_image_parallax');
		}
	...
	add_filter('gotravel_mikado_title_classes', 'gotravel_mikado_title_background_image_classes');
}

if(!function_exists('gotravel_mikado_title_content_alignment_class')) {
	/**
	 ...
	 */
	function gotravel_mikado_title_content_alignment_class($classes) {
		...
		if(($meta_temp = get_post_meta($id, "mkdf_title_area_content_alignment_meta", true)) != "") {
			...
			$title_content_alignment = gotravel_mikado_options()->getOptionValue('title_area_content_alignment');
		}
	...
	add_filter('gotravel_mikado_title_classes', 'gotravel_mikado_title_content_alignment_class');
}

if(!function_exists('gotravel_mikado_title_animation_class')) {
	/**
	 ...
	 * @return array changed array of classes
	 */
	function gotravel_mikado_title_animation_class($classes) {
		...
		if(($meta_temp = get_post_meta($id, "mkdf_title_area_animation_meta", true)) !== "") {
			...
			$title_animation = gotravel_mikado_options()->getOptionValue('title_area_animation');
		}
	...
	add_filter('gotravel_mikado_title_classes', 'gotravel_mikado_title_animation_class');
}

if(!function_exists('gotravel_mikado_title_background_image_div_classes')) {
	/**
	 * @param $classes
	 *
	 * @return array
	 */
	function gotravel_mikado_title_background_image_div_classes($classes) {
	...
	add_filter('gotravel_mikado_title_classes', 'gotravel_mikado_title_background_image_div_classes');
}

if(!function_exists('gotravel_mikado_title_size_body_class')) {
	/**
	 * @param $classes
	 *
	 * @return array
	 */
	function gotravel_mikado_title_size_body_class($classes) {
		$id                  = gotravel_mikado_get_page_id();
		$per_page_title_size = gotravel_mikado_get_meta_field_intersect('title_text_size', $id);
	...
	add_action('body_class', 'gotravel_mikado_title_size_body_class');
}

if(!function_exists('gotravel_mikado_has_subtitle_body_class')) {
	/**
	 * @param $classes
	 *
	 * @return array
	 */
	function gotravel_mikado_has_subtitle_body_class($classes) {
		$id                    = gotravel_mikado_get_page_id();
	...
	add_action('body_class', 'gotravel_mikado_has_subtitle_body_class');
}