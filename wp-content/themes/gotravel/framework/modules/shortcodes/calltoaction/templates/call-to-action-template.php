...
<?php } ?>
	...
	<div class="mkdf-call-to-action <?php echo esc_attr($type) ?>" <?php gotravel_mikado_inline_style($call_to_action_styles); ?>>
		...
		<?php } ?>
				...
				<?php } ?>
					...
					<div class="mkdf-call-to-action-text" <?php echo gotravel_mikado_get_inline_style($content_styles) ?>>
						<?php
				...
				<?php if ($show_button == 'yes') { ?>
					...
					<div class="mkdf-button-wrapper mkdf-call-to-action-column2 mkdf-call-to-action-cell" style ="text-align: <?php echo esc_attr($button_position) ?> ;">
						...
						<?php echo gotravel_mikado_get_button_html($button_parameters); ?>
