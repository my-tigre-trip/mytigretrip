<div <?php gotravel_mikado_class_attribute($pricing_table_classes) ?>>
	<div class="mkdf-price-table-inner">
		...
		<ul>
			<li class="mkdf-table-title">
				<h2 <?php gotravel_mikado_inline_style($title_styles); ?> class="mkdf-title-content"><?php echo esc_html($title) ?></h2>
			</li>
			...
			if(is_array($button_params) && count($button_params)) { ?>
				<li class="mkdf-price-button">
					<?php echo gotravel_mikado_get_button_html($button_params); ?>
				</li>
			<?php } ?>
		</ul>
	</div>
