<?php
namespace GoTravel\Modules\Shortcodes\InfoBox;
...
class InfoBox implements ShortcodeInterface {
	...
	public function vcMap() {
		vc_map(array(
			'name'                      => esc_html__('Mikado Info Box', 'gotravel'),
			'base'                      => $this->base,
			'category'                  => esc_html__('by MIKADO', 'gotravel'),
			'icon'                      => 'icon-wpb-info-box extended-custom-icon',
			'allowed_container_element' => 'vc_row',
			'params'                    => array_merge(
				gotravel_mikado_icon_collections()->getVCParamsArray('', '', true),
				array(
					array(
						'type'        => 'textfield',
					...
					array(
						...
						'value'       => array(
							esc_html__('Same Window', 'gotravel') => '',
					...
					array(
						'type'        => 'colorpicker',
						'heading'     => esc_html__('Button Hover Text Color', 'gotravel'),
	...
	public function render($atts, $content = null) {
		...
		$defaultAtts = array_merge($defaultAtts, gotravel_mikado_icon_collections()->getShortcodeParams());
		...
		return gotravel_mikado_get_shortcode_module_template_part('templates/info-box-template', 'info-box', '', $params);
	}
