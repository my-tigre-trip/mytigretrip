<div <?php mkd_core_class_attribute($holder_classes); ?>>
	<div class="mkdf-pie-chart-doughnut">
		<canvas id="pie<?php echo esc_attr($id); ?>" class="mkdf-doughnut" height="<?php echo esc_html($height); ?>" width="<?php echo esc_html($width); ?>" <?php echo gotravel_mikado_get_inline_attrs($pie_chart_data)?>></canvas>
	</div>
