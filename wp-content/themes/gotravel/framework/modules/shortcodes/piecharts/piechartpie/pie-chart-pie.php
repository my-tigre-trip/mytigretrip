...
class PieChartPie implements ShortcodeInterface {
	...
	public function vcMap() {
		...
		vc_map( array(
			'name' => esc_html__('Mikado Pie Chart 2 (Pie)', 'gotravel'),
			'base' => $this->getBase(),
	...
	public function render($atts, $content = null) {
		...
		$html = gotravel_mikado_get_shortcode_module_template_part('templates/pie-chart-pie', 'piecharts/piechartpie', '', $params);
	...
	private function getHolderClasses($params) {
		$classes = array('mkdf-pie-chart-pie-holder');
