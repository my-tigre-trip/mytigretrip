...
if(!function_exists('gotravel_mikado_configure_visual_composer')) {
	/**
	 * Configuration for Visual Composer
	 * Hooks on vc_after_init action
	 */
	function gotravel_mikado_configure_visual_composer() {
	...
	add_action('vc_after_init', 'gotravel_mikado_configure_visual_composer');

}


if(!function_exists('gotravel_mikado_configure_visual_composer_grid_elemets')) {
	...
	function gotravel_mikado_configure_visual_composer_grid_elemets() {
	...
	add_action('vc_after_init', 'gotravel_mikado_configure_visual_composer_grid_elemets');
}


if(!function_exists('gotravel_mikado_configure_visual_composer_frontend_editor')) {
	/**
	 * Configuration for Visual Composer FrontEnd Editor
	 * Hooks on vc_after_init action
	 */
	function gotravel_mikado_configure_visual_composer_frontend_editor() {
	...
	add_action('vc_after_init', 'gotravel_mikado_configure_visual_composer_frontend_editor');
}
...
if(class_exists('WPBakeryShortCodesContainer')) {
	...
	class WPBakeryShortCode_Mkdf_Info_Items extends WPBakeryShortCodesContainer {
	}
...
/*** Row ***/
if(!function_exists('gotravel_mikado_vc_row_map')) {
	/**
	 * Map VC Row shortcode
	 * Hooks on vc_after_init action
	 */
	function gotravel_mikado_vc_row_map() {
	...
	add_action('vc_after_init', 'gotravel_mikado_vc_row_map');
}

if(!function_exists('gotravel_mikado_empty_space_map')) {
	/**
	 * Adds responsive options to empty space shortcode
	 */
	function gotravel_mikado_empty_space_map() {
		vc_add_param('vc_empty_space', array(
			'type'        => 'textfield',
			'class'       => '',
			'heading'     => 'Large Laptop Height',
			'param_name'  => 'large_laptop',
			'description' => 'Set height of empty space on large laptop browser width',
			'group'       => 'Responsive'
		));
		...
		vc_add_param('vc_empty_space', array(
			'type'        => 'textfield',
			'class'       => '',
			'heading'     => 'Laptop Height',
			'param_name'  => 'laptop',
			'description' => 'Set height of empty space on laptop browser width',
			'group'       => 'Responsive'
		));
		...
		vc_add_param('vc_empty_space', array(
			'type'        => 'textfield',
			'class'       => '',
			'heading'     => 'Tablet Landscape Height',
			'param_name'  => 'tablet_landscape',
			'description' => 'Set height of empty space on tablet landscape browser width',
			'group'       => 'Responsive'
		));
		...
		vc_add_param('vc_empty_space', array(
			'type'        => 'textfield',
			'class'       => '',
			'heading'     => 'Tablet Portrait Height',
			'param_name'  => 'tablet_portrait',
			'description' => 'Set height of empty space on tablet portrait browser width',
			'group'       => 'Responsive'
		));
		...
		vc_add_param('vc_empty_space', array(
			'type'        => 'textfield',
			'class'       => '',
			'heading'     => 'Phone Landscape Height',
			'param_name'  => 'phone_landscape',
			'description' => 'Set height of empty space on phone landscape browser width',
			'group'       => 'Responsive'
		));
		...
		vc_add_param('vc_empty_space', array(
			'type'        => 'textfield',
			'class'       => '',
			'heading'     => 'Phone Portrait Height',
			'param_name'  => 'phone_portrait',
			'description' => 'Set height of empty space on phone portrait browser width',
			'group'       => 'Responsive'
		));
	}

	add_action('vc_after_init', 'gotravel_mikado_empty_space_map');
}
