...
if(!function_exists('gotravel_mikado_fonts_options_map')) {
	/**
	 * Font options page
	 */
	function gotravel_mikado_fonts_options_map() {
		
		gotravel_mikado_add_admin_page(
			array(
				'slug' => '_fonts_page',
				'title' => esc_html__('Fonts', 'gotravel'),
				'icon' => 'fa fa-font'
			)
		);
		 ...
		 * Headings
		 */
		$panel_headings = gotravel_mikado_add_admin_panel(
			array(
				'page' => '_fonts_page',
				'name' => 'panel_headings',
				'title' => esc_html__('Headings', 'gotravel')
			)
		);
		
		//H1
		$group_heading_h1 = gotravel_mikado_add_admin_group(array(
			'name'			=> 'group_heading_h1',
			'title'			=> esc_html__('H1 Style', 'gotravel'),
			'description'	=> esc_html__('Define styles for h1 heading', 'gotravel'),
			'parent'		=> $panel_headings
		));
		
		$row_heading_h1_1 = gotravel_mikado_add_admin_row(array(
		...
		$row_heading_h1_2 = gotravel_mikado_add_admin_row(array(
		...
		$row_heading_h1_3 = gotravel_mikado_add_admin_row(array(
		...
		gotravel_mikado_add_admin_field(array(
			...
			'name'			=> 'h1_margin_top',
			'default_value'	=> '',
			'label'			=> esc_html__('Margin Top', 'gotravel'),
		...
		gotravel_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Margin Bottom', 'gotravel'),
			'parent'		=> $row_heading_h1_3
		));
		
		//H2
		$group_heading_h2 = gotravel_mikado_add_admin_group(array(
			'name'			=> 'group_heading_h2',
			'title'			=> esc_html__('H2 Style', 'gotravel'),
			'description'	=> esc_html__('Define styles for h2 heading', 'gotravel'),
			'parent'		=> $panel_headings
		));
		
		$row_heading_h2_1 = gotravel_mikado_add_admin_row(array(
		...
		$row_heading_h2_2 = gotravel_mikado_add_admin_row(array(
		...
		$row_heading_h2_3 = gotravel_mikado_add_admin_row(array(
		...
		//H3
		$group_heading_h3 = gotravel_mikado_add_admin_group(array(
			'name'			=> 'group_heading_h3',
			'title'			=> esc_html__('H3 Style', 'gotravel'),
			'description'	=> esc_html__('Define styles for h3 heading', 'gotravel'),
			'parent'		=> $panel_headings
		));
		
		$row_heading_h3_1 = gotravel_mikado_add_admin_row(array(
		...
		$row_heading_h3_2 = gotravel_mikado_add_admin_row(array(
		...
		$row_heading_h3_3 = gotravel_mikado_add_admin_row(array(
		...
		//H4
		$group_heading_h4 = gotravel_mikado_add_admin_group(array(
			'name'			=> 'group_heading_h4',
			'title'			=> esc_html__('H4 Style', 'gotravel'),
			'description'	=> esc_html__('Define styles for h4 heading', 'gotravel'),
			'parent'		=> $panel_headings
		));
		
		$row_heading_h4_1 = gotravel_mikado_add_admin_row(array(
		...
		$row_heading_h4_2 = gotravel_mikado_add_admin_row(array(
		...
		$row_heading_h4_3 = gotravel_mikado_add_admin_row(array(
		...
		//H5
		$group_heading_h5 = gotravel_mikado_add_admin_group(array(
			'name'			=> 'group_heading_h5',
			'title'			=> esc_html__('H5 Style', 'gotravel'),
			'description'	=> esc_html__('Define styles for h5 heading', 'gotravel'),
			'parent'		=> $panel_headings
		));
		
		$row_heading_h5_1 = gotravel_mikado_add_admin_row(array(
		...
		$row_heading_h5_2 = gotravel_mikado_add_admin_row(array(
		...
		$row_heading_h5_3 = gotravel_mikado_add_admin_row(array(
		...
		//H6
		$group_heading_h6 = gotravel_mikado_add_admin_group(array(
			'name'			=> 'group_heading_h6',
			'title'			=> esc_html__('H6 Style', 'gotravel'),
			'description'	=> esc_html__('Define styles for h6 heading', 'gotravel'),
			'parent'		=> $panel_headings
		));
		
		$row_heading_h6_1 = gotravel_mikado_add_admin_row(array(
		...
		$row_heading_h6_2 = gotravel_mikado_add_admin_row(array(
		...
		$row_heading_h6_3 = gotravel_mikado_add_admin_row(array(
		 ...
		 */
		$panel_responsive_headings3 = gotravel_mikado_add_admin_panel(
			array(
				'page' => '_fonts_page',
				'name' => 'panel_responsive_headings3',
				'title' => esc_html__('Headings Responsive (Tablet Landscape View)', 'gotravel')
			)
		);
		
		//H1
		$group_responsive3_heading_h1 = gotravel_mikado_add_admin_group(array(
			'name'			=> 'group_responsive3_heading_h1',
			'title'			=> esc_html__('H1 Responsive Style', 'gotravel'),
			'description'	=> esc_html__('Define responsive styles for h1 heading', 'gotravel'),
			'parent'		=> $panel_responsive_headings3
		));
		
		$row_responsive_heading_h1_3 = gotravel_mikado_add_admin_row(array(
		...
		//H2
		$group_responsive3_heading_h2 = gotravel_mikado_add_admin_group(array(
			'name'			=> 'group_responsive3_heading_h2',
			'title'			=> esc_html__('H2 Responsive Style', 'gotravel'),
			'description'	=> esc_html__('Define responsive styles for h2 heading', 'gotravel'),
			'parent'		=> $panel_responsive_headings3
		));
		
		$row_responsive_heading_h2_3 = gotravel_mikado_add_admin_row(array(
		...
		//H3
		$group_responsive3_heading_h3 = gotravel_mikado_add_admin_group(array(
			'name'			=> 'group_responsive3_heading_h3',
			'title'			=> esc_html__('H3 Responsive Style', 'gotravel'),
			'description'	=> esc_html__('Define responsive styles for h3 heading', 'gotravel'),
			'parent'		=> $panel_responsive_headings3
		));
		
		$row_responsive_heading_h3_3 = gotravel_mikado_add_admin_row(array(
		...
		//H4
		$group_responsive3_heading_h4 = gotravel_mikado_add_admin_group(array(
			'name'			=> 'group_responsive3_heading_h4',
			'title'			=> esc_html__('H4 Responsive Style', 'gotravel'),
			'description'	=> esc_html__('Define responsive styles for h4 heading', 'gotravel'),
			'parent'		=> $panel_responsive_headings3
		));
		
		$row_responsive_heading_h4_3 = gotravel_mikado_add_admin_row(array(
		...
		//H5
		$group_responsive3_heading_h5 = gotravel_mikado_add_admin_group(array(
			'name'			=> 'group_responsive3_heading_h5',
			'title'			=> esc_html__('H5 Responsive Style', 'gotravel'),
			'description'	=> esc_html__('Define responsive styles for h5 heading', 'gotravel'),
			'parent'		=> $panel_responsive_headings3
		));
		
		$row_responsive_heading_h5_3 = gotravel_mikado_add_admin_row(array(
		...
		//H6
		$group_responsive3_heading_h6 = gotravel_mikado_add_admin_group(array(
			'name'			=> 'group_responsive3_heading_h6',
			'title'			=> esc_html__('H6 Responsive Style', 'gotravel'),
			'description'	=> esc_html__('Define responsive styles for h6 heading', 'gotravel'),
			'parent'		=> $panel_responsive_headings3
		));
		
		$row_responsive_heading_h6_3 = gotravel_mikado_add_admin_row(array(
		 ...
		 */
		$panel_responsive_headings = gotravel_mikado_add_admin_panel(
			array(
				'page' => '_fonts_page',
				'name' => 'panel_responsive_headings',
				'title' => esc_html__('Headings Responsive (Tablet Portrait View)', 'gotravel')
			)
		);
		
		//H1
		$group_responsive_heading_h1 = gotravel_mikado_add_admin_group(array(
		...
		$row_responsive_heading_h1_1 = gotravel_mikado_add_admin_row(array(
		...
		//H2
		$group_responsive_heading_h2 = gotravel_mikado_add_admin_group(array(
		...
		$row_responsive_heading_h2_1 = gotravel_mikado_add_admin_row(array(
		...
		//H3
		$group_responsive_heading_h3 = gotravel_mikado_add_admin_group(array(
		...
		$row_responsive_heading_h3_1 = gotravel_mikado_add_admin_row(array(
		...
		//H4
		$group_responsive_heading_h4 = gotravel_mikado_add_admin_group(array(
		...
		$row_responsive_heading_h4_1 = gotravel_mikado_add_admin_row(array(
		...
		//H5
		$group_responsive_heading_h5 = gotravel_mikado_add_admin_group(array(
		...
		$row_responsive_heading_h5_1 = gotravel_mikado_add_admin_row(array(
		...
		//H6
		$group_responsive_heading_h6 = gotravel_mikado_add_admin_group(array(
		...
		$row_responsive_heading_h6_1 = gotravel_mikado_add_admin_row(array(
		 ...
		 */
		$panel_responsive_headings2 = gotravel_mikado_add_admin_panel(
			array(
				'page' => '_fonts_page',
				'name' => 'panel_responsive_headings2',
				'title' => esc_html__('Headings Responsive (Mobile Devices)', 'gotravel')
			)
		);
		
		//H1
		$group_responsive2_heading_h1 = gotravel_mikado_add_admin_group(array(
		...
		$row_responsive2_heading_h1_1 = gotravel_mikado_add_admin_row(array(
		...
		//H2
		$group_responsive2_heading_h2 = gotravel_mikado_add_admin_group(array(
		...
		$row_responsive2_heading_h2_1 = gotravel_mikado_add_admin_row(array(
		...
		//H3
		$group_responsive2_heading_h3 = gotravel_mikado_add_admin_group(array(
		...
		$row_responsive2_heading_h3_1 = gotravel_mikado_add_admin_row(array(
		...
		//H4
		$group_responsive2_heading_h4 = gotravel_mikado_add_admin_group(array(
		...
		$row_responsive2_heading_h4_1 = gotravel_mikado_add_admin_row(array(
		...
		//H5
		$group_responsive2_heading_h5 = gotravel_mikado_add_admin_group(array(
		...
		$row_responsive2_heading_h5_1 = gotravel_mikado_add_admin_row(array(
		...
		//H6
		$group_responsive2_heading_h6 = gotravel_mikado_add_admin_group(array(
		...
		$row_responsive2_heading_h6_1 = gotravel_mikado_add_admin_row(array(
		 ...
		 * Text
		 */
		$panel_text = gotravel_mikado_add_admin_panel(
			array(
				'page' => '_fonts_page',
				'name' => 'panel_text',
		...
		$group_text = gotravel_mikado_add_admin_group(array(
			'name'			=> 'group_text',
			'title'			=> esc_html__('Paragraph', 'gotravel'),
			'description'	=> esc_html__('Define styles for paragraph text', 'gotravel'),
			'parent'		=> $panel_text
		));
		
		$row_text_1 = gotravel_mikado_add_admin_row(array(
			'name'		=> 'row_text_1',
			'parent'	=> $group_text
		));
		...
		$row_text_2 = gotravel_mikado_add_admin_row(array(
			'name'		=> 'row_text_2',
			'parent'	=> $group_text,
			'next'		=> true
		));
		...
		$group_text_res1 = gotravel_mikado_add_admin_group(array(
			'name'			=> 'group_text_res1',
			'title'			=> esc_html__('Paragraph Responsive (Table Portrait View)', 'gotravel'),
			'description'	=> esc_html__('Define responsive styles for paragraph text for table devices - portrait view', 'gotravel'),
			'parent'		=> $panel_text
		));
		
		$row_res_text_1 = gotravel_mikado_add_admin_row(array(
			'name'		=> 'row_text_1',
		...
		$group_text_res2 = gotravel_mikado_add_admin_group(array(
			'name'			=> 'group_text_res2',
			'title'			=> esc_html__('Paragraph Responsive (Mobile Devices)', 'gotravel'),
			'description'	=> esc_html__('Define responsive styles for paragraph text for mobile devices', 'gotravel'),
			'parent'		=> $panel_text
		));
		
		$row_res_text_2 = gotravel_mikado_add_admin_row(array(
			'name'		=> 'row_res_text_2',
		...
		$group_link = gotravel_mikado_add_admin_group(array(
			'name'			=> 'group_link',
			'title'			=> esc_html__('Links', 'gotravel'),
			'description'	=> esc_html__('Define styles for link text', 'gotravel'),
			'parent'		=> $panel_text
		));
		
		$row_link_1 = gotravel_mikado_add_admin_row(array(
			'name'		=> 'row_link_1',
			'parent'	=> $group_link
		));
		...
		gotravel_mikado_add_admin_field(array(
			...
			'name'			=> 'link_color',
			'default_value'	=> '',
			'label'			=> esc_html__('Link Color', 'gotravel'),
			'parent'		=> $row_link_1
		));
		...
		gotravel_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Hover Link Color', 'gotravel'),
			'parent'		=> $row_link_1
		));
		
		$row_link_2 = gotravel_mikado_add_admin_row(array(
			'name'		=> 'row_link_2',
			'parent'	=> $group_link,
			'next'		=> true
		));
		...
		gotravel_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Link Decoration', 'gotravel'),
			'options'		=> gotravel_mikado_get_text_decorations(),
			'parent'		=> $row_link_2
		));
		...
		gotravel_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Hovel Link Decoration', 'gotravel'),
			'options'		=> gotravel_mikado_get_text_decorations(),
			'parent'		=> $row_link_2
		));
	}

	add_action('gotravel_mikado_options_map', 'gotravel_mikado_fonts_options_map', 2);
}