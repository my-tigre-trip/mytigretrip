				...
				},
				{
					...
					onclick: function() {
						ed.windowManager.open( {
							...
							onsubmit: function( e ) {
								ed.insertContent('[mkdf_unordered_list style="' + e.data.style + '" animate="' + e.data.animate + '"]<ul><li>Lorem ipsum</li><li>Lorem ipsum</li><li>Lorem ipsum</li></ul>[/mkdf_unordered_list]');
							}
						});
					}
				}
