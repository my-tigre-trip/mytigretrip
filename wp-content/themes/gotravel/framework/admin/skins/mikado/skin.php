...
class MikadoSkin extends GoTravelMikadoSkinAbstract {
    /**
     * Skin constructor. Hooks to gotravel_mikado_admin_scripts_init and gotravel_mikado_enqueue_admin_styles
     */
    public function __construct() {
        $this->skinName = 'mikado';

        //hook to
        add_action('gotravel_mikado_admin_scripts_init', array($this, 'registerStyles'));
        add_action('gotravel_mikado_admin_scripts_init', array($this, 'registerScripts'));

        add_action('gotravel_mikado_enqueue_admin_styles', array($this, 'enqueueStyles'));
        add_action('gotravel_mikado_enqueue_admin_scripts', array($this, 'enqueueScripts'));

        add_action('gotravel_mikado_enqueue_meta_box_styles', array($this, 'enqueueStyles'));
        add_action('gotravel_mikado_enqueue_meta_box_scripts', array($this, 'enqueueScripts'));
    ...
    public function registerScripts() {
	    $this->scripts['js-wp-editor'] = 'assets/js/js-wp-editor.js';
        ...
        foreach ($this->scripts as $scriptHandle => $scriptPath) {
            gotravel_mikado_register_skin_script($scriptHandle, $scriptPath, array(), false, true);
        }
    }
    ...
    public function registerStyles() {
        ...
        foreach ($this->styles as $styleHandle => $stylePath) {
            gotravel_mikado_register_skin_style($styleHandle, $stylePath);
        }
    }
    ...
    public function renderOptions() {
        ...
        $tab    		= gotravel_mikado_get_admin_tab();
        $active_page 	= $gotravel_mikado_Framework->mkdOptions->getAdminPageFromSlug($tab);
     ...
     *
*@param GoTravelMikadoAdminPage $page current page to load
    ...
    public function renderImport() { ?>
        <div class="mkdf-options-page mkdf-page">
            <?php $this->getHeader(gotravel_mikado_get_theme_info_item('Name'), gotravel_mikado_get_theme_info_item('Version'), false); ?>
            <div class="mkdf-page-content-wrapper">
                <div class="mkdf-page-content">
                    <div class="mkdf-page-navigation mkdf-tabs-wrapper vertical left clearfix">
