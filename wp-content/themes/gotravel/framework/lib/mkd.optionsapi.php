<?php
if(!function_exists('gotravel_mikado_add_admin_page')) {
	/**
	 ...
	 * @param $attributes
	 *
	 * @return bool|GoTravelMikadoAdminPage
	 */
	function gotravel_mikado_add_admin_page($attributes) {
		$slug  = '';
		$title = '';
		$icon  = '';
		...
		if(isset($slug) && !empty($title)) {
			$admin_page = new GoTravelMikadoAdminPage($slug, $title, $icon);
			gotravel_mikado_framework()->mkdOptions->addAdminPage($slug, $admin_page);
...
if(!function_exists('gotravel_mikado_add_admin_panel')) {
	/**
	 ...
	 * @param $attributes
	 *
	 * @return bool|GoTravelMikadoPanel
	 */
...
if(!function_exists('gotravel_mikado_add_admin_container')) {
	/**
	 ...
	 * @param $attributes
	 *
	 * @return bool|GoTravelMikadoContainer
	 */
...
if(!function_exists('gotravel_mikado_add_admin_twitter_button')) {
	 ...
	 * @param $attributes
	 *
	 * @return bool|GoTravelMikadoTwitterFramework
	 */
	function gotravel_mikado_add_admin_twitter_button($attributes) {
		$name   = '';
		$parent = '';
		...
		if(!empty($parent) && !empty($name)) {
			$field = new GoTravelMikadoTwitterFramework();
...
if(!function_exists('gotravel_mikado_add_admin_instagram_button')) {
	/**
	 * Generates instagram button field
	 *
	 * @param $attributes
	 *
	 * @return bool|GoTravelMikadoInstagramFramework
	 */
	function gotravel_mikado_add_admin_instagram_button($attributes) {
		$name   = '';
		$parent = '';
		...
		if(!empty($parent) && !empty($name)) {
			$field = new GoTravelMikadoInstagramFramework();
...
if(!function_exists('gotravel_mikado_add_admin_container_no_style')) {
	/**
	 * Generates container object
	 * $attributes can contain:
	 *      $name - name of the container with which it will be added to parent element
	 ...
	 * @param $attributes
	 *
	 * @return bool|GoTravelMikadoContainerNoStyle
	 */
...
if(!function_exists('gotravel_mikado_add_admin_group')) {
	/**
	 ...
	 * @param $attributes
	 *
	 * @return bool|GoTravelMikadoGroup
	 */
...
if(!function_exists('gotravel_mikado_add_admin_row')) {
	/**
	 ...
	 * @param $attributes
	 *
	 * @return bool|GoTravelMikadoRow
	 */
	function gotravel_mikado_add_admin_row($attributes) {
		$parent = '';
		$next   = false;
		$name   = '';
		...
		if(is_object($parent)) {
			$row = new GoTravelMikadoRow($next);
...
if(!function_exists('gotravel_mikado_add_admin_field')) {
	/**
	 ...
	 * @param $attributes
	 *
	 * @return bool|GoTravelMikadoField
	 */
	function gotravel_mikado_add_admin_field($attributes) {
		$type            = '';
		$name            = '';
		$default_value   = '';
		$label           = '';
...
if(!function_exists('gotravel_mikado_add_admin_section_title')) {
	/**
	 ...
	 * @param $attributes
	 *
	 * @return bool|GoTravelMikadoTitle
	 */
	function gotravel_mikado_add_admin_section_title($attributes) {
		$parent = '';
		$name   = '';
		$title  = '';
		...
		if(is_object($parent) && !empty($title) && !empty($name)) {
			$section_title = new GoTravelMikadoTitle($name, $title);
...
if(!function_exists('gotravel_mikado_add_admin_notice')) {
	/**
	 * Generates GoTravelMikadoNotice object from given parameters
	 ...
	 * @param $attributes
	 *
	 * @return bool|GoTravelMikadoNotice
	 */
...
if(!function_exists('gotravel_mikado_framework')) {
	/**
	 * Function that returns instance of GoTravelMikadoFramework class
	 *
	 * @return GoTravelMikadoFramework
	 */
	function gotravel_mikado_framework() {
		return GoTravelMikadoFramework::get_instance();
	}
}

if(!function_exists('gotravel_mikado_options')) {
	/**
	 * Returns instance of GoTravelMikadoOptions class
	 *
	 * @return GoTravelMikadoOptions
	 */
	function gotravel_mikado_options() {
		return gotravel_mikado_framework()->mkdOptions;
	}
}
 ...
 */
if(!function_exists('gotravel_mikado_add_meta_box')) {
	/**
	 * Adds new meta box
	 *
	 * @param $attributes
	 *
	 * @return bool|GoTravelMikadoMetaBox
	 */
...
if(!function_exists('gotravel_mikado_add_meta_box_field')) {
	/**
...
if(!function_exists('gotravel_mikado_add_multiple_images_field')) {
	/**
	 * Generates meta box field object
	 * $attributes can contain:
	 *      $name - name of the field. This will be name of the option in database
	 ...
	 * @return bool|GoTravelMikadoField
	 */
	function gotravel_mikado_add_multiple_images_field($attributes) {
		$name        = '';
		$label       = '';
		$description = '';
		$parent      = '';
		...
		if(!empty($parent) && !empty($name)) {
			$field = new GoTravelMikadoMultipleImages($name, $label, $description);
...
if(!function_exists('gotravel_mikado_get_yes_no_select_array')) {
	/**
	 * Returns array of yes no
	 * @return array
	 */
	function gotravel_mikado_get_yes_no_select_array($enable_default = true, $set_yes_to_be_first = false) {
		$select_options = array();

		if($enable_default) {
			$select_options[''] = esc_html__('Default', 'gotravel');
		}

		if($set_yes_to_be_first) {
			$select_options['yes'] = esc_html__('Yes', 'gotravel');
			$select_options['no'] = esc_html__('No', 'gotravel');
		} else {
			$select_options['no'] = esc_html__('No', 'gotravel');
			$select_options['yes'] = esc_html__('Yes', 'gotravel');
		}
...
if(!function_exists('gotravel_mikado_get_font_weight_array')) {
	/**
	 ...
	 * @return array
	 */
	function gotravel_mikado_get_font_weight_array($first_empty = false) {
		$font_weights = array();
...
if(!function_exists('gotravel_mikado_get_text_transform_array')) {
	/**
...
if(!function_exists('gotravel_mikado_get_font_style_array')) {
	/**
...
if(!function_exists('gotravel_mikado_get_text_decorations')) {
	/**
	 * Returns array of text transforms
	 *
	 * @param bool $first_empty
...
if(!function_exists('gotravel_mikado_get_title_tag')) {
	/**
	 ...
	 * @return array
	 */
	function gotravel_mikado_get_title_tag($first_empty = false, $additional_elements = array()) {
		$title_tag = array();

		if($first_empty) {
			$title_tag[''] = esc_html__('Default', 'gotravel');
		}
...
if(!function_exists('gotravel_mikado_is_font_option_valid')) {
	/**
...
if(!function_exists('gotravel_mikado_get_font_option_val')) {
	/**
	 ...
	 * @return mixed
	 */
	function gotravel_mikado_get_font_option_val($option_val) {
...
if(!function_exists('gotravel_mikado_add_repeater_field')) {
	/**
	 * Generates meta box field object
	 * $attributes can contain:
	 *      $name - name of the field. This will be name of the option in database
