 ...
 * 
*/
class AgencyFormatter extends TripFormatter{
  #agency data
  ...
  public function setZohoApiNames() {
    // agency data
    $this->agencyName['apiName'] = 'agencyName';
    $this->guideName['apiName'] = 'guideName';
    $this->operator['apiName'] = 'operator';
    $this->guidePhone['apiName'] = 'guidePhone';
    $this->operatorPhone['apiName'] = 'operatorPhone';
  ...
  public function assignValues() {    
    ...
    $this->salesChannel['value'] = CHANNEL_AGENCY;

    // pricing
    $this->priceList['value'] = CHANNEL_AGENCY_ES;
    ...
    // agency
    $this->agencyName['value'] = $r->agencyName;
    $this->guideName['value'] = $r->guideName;
    $this->operator['value'] = $r->operator;
    $this->guidePhone['value'] = $r->guidePhone;
    $this->operatorPhone['value'] = $r->operatorPhone;
  }
