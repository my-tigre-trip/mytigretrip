<?php
namespace MikadofTours\CPT;

use MikadofTours\CPT\Destination\DestinationsRegister;
use MikadofTours\Lib;

/**
 * Class PostTypesLoader
 * @package MikadofTours\CPT
 */
class PostTypesRegister {
    ...
    private function addPostTypes() {
        $this->addPostType(new Tours\ToursRegister());
        $this->addPostType(new Attributes\AttributesRegister());
        $this->addPostType(new Destination\DestinationsRegister());
    }
