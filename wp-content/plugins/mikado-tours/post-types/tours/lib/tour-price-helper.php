...
class TourPriceHelper {
	...
	public function getCurrencySymbol() {
		...
		$symbol = gotravel_mikado_options()->getOptionValue('tours_currency_symbol');
	...
	public function getCurrencyPosition() {
		...
		$position = gotravel_mikado_options()->getOptionValue('tours_currency_symbol_position');
	...
	public function getEdgePrices() {
		...
		if(mkdf_tours_is_wpml_installed()) {
			...
			$sql = "SELECT MAX(CAST(pm.meta_value AS UNSIGNED)) as max_price,
					...
					WHERE pm.meta_key IN ('mkdf_tours_price', 'mkdf_tours_discount_price')
