...
class ToursGrid implements ShortcodeInterface {
	private $base;

	/**
	 * ToursGrid constructor.
	 */
	public function __construct() {
		$this->base = 'mkdf_tours_grid';
	...
	public function vcMap() {
		vc_map(array(
			'name'                      => esc_html__('Mikado Tours Grid', 'mikado-tours'),
			'base'                      => $this->base,
	...
	public function render($atts, $content = null) {
		...
		return mkdf_tours_get_tour_module_template_part('templates/tours-grid-template', 'tour-item', 'shortcodes', '', $params);
	}

	private function buildQueryObject($params) {
		$queryArray['post_status'] = 'published';
		$queryArray['post_type'] = 'tour-item';
