<?php global $gotravel_mikado_fonts_array;
$gotravel_mikado_fonts_array =
	array(
		0   =>
			array(
		...
		8   =>
			array(
				...
				'files'        =>
					array(
						'regular' => 'http://fonts.gstatic.com/s/aguafinascript/v5/65g7cgMtMGnNlNymkd_Z6CvMxLhO8OSNnfAp53LK1_iRs.ttf',
					),
			),
		9   =>
			array(
			...
			array(
				...
				'files'        =>
					array(
						...
						700         => 'http://fonts.gstatic.com/s/cabin/v7/4EKhProuY1hmkd_WCAomq9Dg.ttf',
			...
			array(
				...
				'files'        =>
					array(
						...
						600         => 'http://fonts.gstatic.com/s/exo/v4/mkd_SG5kXUmOcIvFpgtdZnlw.ttf',
		...
		397 =>
			array(
				...
				'files'        =>
					array(
						'regular' => 'http://fonts.gstatic.com/s/mavenpro/v7/sqPJIFG4gqsjl-0mkd_46Gbw.ttf',
			...
			array(
				...
				'files'        =>
					array(
						...
						700         => 'http://fonts.gstatic.com/s/robotocondensed/v13/b9QBgL0iMZfDSpmcXcE8nPOYkGiSOYDmkd_T7HbIOV1hA.ttf',
