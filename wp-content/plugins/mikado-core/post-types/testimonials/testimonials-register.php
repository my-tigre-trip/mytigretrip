...
class TestimonialsRegister implements Lib\PostTypeInterface {
	...
	private function registerPostType() {
		...
		if(mkd_core_theme_installed()) {
			$menuPosition = $gotravel_mikado_Framework->getSkin()->getMenuItemPosition('testimonial');
			$menuIcon     = $gotravel_mikado_Framework->getSkin()->getMenuIcon('testimonial');
		}
		...
		register_post_type('testimonials',
			array(
				'labels'        => array(
					...
					'menu_name'     => esc_html__('Mikado Testimonials', 'mikado-core'),
